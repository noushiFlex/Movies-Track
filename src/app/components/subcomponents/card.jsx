  ...
  return (
    <div className="border rounded-lg h-[300px] w-full relative flex-col overflow-scroll">
      ...
      <div className="mt-24 flex flex-col mb-[-5px] px-1">
        <label className=" w-full text-center">10/10</label>
        <label className="font-semibold w-full text-center break-all text-xl">SQUID GAME</label>
        <hr className="m-auto w-8/12" />
        <div className="flex flex-col mt-6 gap-4">
          <div className="flex flex-col justify-start">
            <label className="font-semibold">Description</label>
            <label className="break-all">Description</label>
          </div>
          <div className="flex flex-col justify-start">
